                            ...
                            <div class="card-body p-5">
                                ...
                                <form action="signup" method="post">
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example3cg"><i class="fa fa-user"></i>
                                            Your Name</label>
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example4cg"><i class="fa fa-lock"></i>
                                            Password</label>
                                    ...
                                    <p class="text-center text-muted mt-5 mb-0">Already Have an account? <a href="{{url('login')}}"
