...
<nav class="navbar navbar-expand-lg bg-white">
        <div class="container">
            <a class="navbar-brand" href="{{url('dashboard')}}"><b><i class="fa fa-dashboard"></i> Dashboard</b></a>
                ...
                <ul class="navbar-nav me-auto mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{url('feedback')}}">View <i class="fa fa-eye"></i></a></li>
                        </ul>
                    </li>
                    <!-- END Dropdown -->
                </ul>
